...
Vi kan se på histogrammet at høyden er normalfordelt. Dette tyder på at datasettet er jevnt fordelt med tanke på deltakerene involvert. Dette ser ut som en random sample som fører til at undersøkelsen ikke får noen tydelig bias. 
...
```
Vi kan se på histogrammet at høyden er normalfordelt. Dette histogrammet forklarer oss hvordan utvalget i datasettet er valgt. Faktumet bak at histogrammet er normalfordelt tyder på at det er et variert utvalg av individer, for at datasettet ikke skal få en tydelig bias.  
=======
...
>>>>>>> eb329536ce7ff0d79af79a69ca526101761a6190
